...
## 📊 Enfoque actual
Me encuentro en formación en **ciencia de datos y análisis**, aplicando herramientas digitales para:
- Diagnósticos ambientales
- Visualización de datos
- Análisis de indicadores ambientales y ESG
...
## 🤝 Colaboraciones
Interesada en colaborar en:
- Proyectos de datos para sostenibilidad
- Iniciativas ambientales y climáticas
...
## 📫 Contacto
- LinkedIn: [linkedin.com/in/nicole-odarjauregui](https://www.linkedin.com/in/nicole-odarjauregui)
- Email: odarnicole@gmail.com

<!--
**odarnicole-hub/odarnicole-hub** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
